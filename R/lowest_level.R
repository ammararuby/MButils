...
#'
#' @description Identifies the lowest taxonomic name available for each ASV
#' in a phyloseq taxonomy table and aggregates them in a new column.
#'
...
#' identified.  Duplicates are labeled uniquely by appending an integer.
#' @export
#'
#'nan
